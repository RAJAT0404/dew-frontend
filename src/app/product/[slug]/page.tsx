      ...
      <main className="flex-1 pt-32 pb-20">
        <div className="max-w-7xl mx-auto w-full px-6 lg:px-10">
          ...
          <section className="mb-10 animate-fade-in-up">
            <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-ink leading-[1.12] mb-3">
              {product.name}
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-muted">
              ...
              <span
                className="w-1 h-1 rounded-full bg-line-strong"
                aria-hidden="true"
              />
          ...
          <section className="grid lg:grid-cols-5 gap-8 mb-16 animate-fade-in-up delay-100">
            <div className="lg:col-span-3">
              {/* Image */}
              <div className="rounded-2xl overflow-hidden border border-line bg-surface shadow-sm relative aspect-4/3">
                <Image
                  src={product.image}
                  alt={product.name}
                  fill
                  ...
                  <dl className="flex flex-col gap-3 text-sm">
                    {Object.entries(product.specifications).map(
                      ([key, value]) => (
                        <div
                          key={key}
                          className="flex justify-between items-baseline gap-4 border-b border-line pb-2 last:border-0 last:pb-0"
                        >
              ...
              <div className="bg-emerald-bg border border-emerald-border rounded-2xl p-6 sticky top-24">
                ...
                <div className="mt-6 pt-6 border-t border-emerald-border/30">
                  ...
                  <p className="text-xs text-emerald-text/80 mt-1 font-medium">
                    Content derived from manufacturer whitepapers and industry
                    benchmarking.
                  </p>
                </div>
              </div>
